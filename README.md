...
*Figure 1: Ingestion sequence diagram mapping the email notification from Gmail, validation, to raw PDF upload.*
...
<img src="docs/diagrams/multi-agent-flow.png" alt="Multi-Agent Flow" width="550" />
*Figure 2: Flow chart of the 3-Stage multi-agent pipeline demonstrating manual state passing and distinct tool boundaries.*
...
<img src="docs/diagrams/system-architecture.png" alt="System Architecture" width="550" />
*Figure 3: High-level System Architecture illustrating the decoupled Ingestor and Agent Cloud Run services.*
